...
📍 **Austria ↔ Hong Kong** | 💻 **Fullstack dev** | 🔮 **Pyth & Fogo community contributor** | ⚙️ **ex-NodeStake contributor** | 🛰️ **former Saga ambassador**
...
- ⛓️ **Web3 integration** - connecting product experiences to wallets, token flows, contracts, and protocol-facing workflows
